...
import { type MessageKey, type MessageValue, inputTopic, outputTopic } from './custom-class-error-handler.fixtures';

@Controller()
@UseFilters(new TestAllExceptionsFilter()) // avoid default NestJS ExceptionsHandler to re-map the thrown error.
export class CustomClassErrorHandlerController {
  constructor(
